...
import logging from './loggerMiddleware/logger.js';
...
app.post('/shorturls', logging, (req, res) => {
...
app.get('/shorturls/:shortcode',logging, (req, res) => {
...
app.get('/shorturls/:shortcode/stats',logging, (req, res) => {
    const { shortcode } = req.params;
    const entry = db[shortcode];
